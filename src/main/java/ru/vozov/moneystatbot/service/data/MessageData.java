...
public class MessageData {
    public static final String START_MESSAGE = """
                        ...
                        ✅Показывать историю сохраненных операций за разные промежутки времени🗂
                        """;
    ...
    public static final String OPERATION_START_MESSAGE = """
                        ...
                        """;
    public static final String OPERATION_EXISTS_IN_CREATION_MESSAGE = """
                        У вас есть операция в процессе создания, для того чтобы создать новую необходимо отменить предыдущую.
                        После отмены повторите попытку.
                        """;
    public static final String ASK_OPERATION_SUM_MESSAGE =
                        """
                        Введите сумму операции. Если число дробное, разделяйтя целую и дробную части точкой.
    ...
    public static final String OPERATION_CANCELED_MESSAGE = "Данная операция была отменена";
    ...
    public static final String ASK_STATISTICS_TYPE_MESSAGE = """
                        Здесь вы можете смотреть статистику Ваших доходов и расходов📊
                        Выберите по какому типу операции Вы хотите посмотреть статистику.
                        """;
    public static final String ASK_STATISTICS_PERIOD_MESSAGE = "Выберите за какой промежуток времени Вы хотите посмотреть статистику\uD83D\uDCC6";
    public static final String NO_STATISTICS_DATA_MESSAGE = """
                        У Вас еще нет данных для просмотра статистики.
                        ...
                        """;
    public static final String ASK_STATISTICS_YEAR_MESSAGE = "Выберите за какой год Вы хотите посмотреть статистику";
    public static final String ASK_STATISTICS_MONTH_MESSAGE = "Выберите за какой месяц Вы хотите посмотреть статистику";
    public static final String ASK_STATISTICS_DAY_MESSAGE = "Выберите за какой день Вы хотите посмотреть статистику";
    public static final String STATISTICS_FOR_ALL_TIME_MESSAGE = "Ваша статистика %s за все время📊\n\n";
    public static final String CATEGORY_STATISTICS_MESSAGE = "%s %.2f%% %.2f₽\n";
    public static final String STATISTICS_FOR_YEAR_MESSAGE = "Ваша статистика %s за %d год📊\n\n";
    public static final String NO_STATISTICS_DATA_FOR_MONTH_MESSAGE = "За данный месяц у Вас не было %s.";
    public static final String STATISTICS_FOR_MONTH_MESSAGE = "Ваша статистика %s за %s %d года📊\n\n";
    public static final String NO_STATISTICS_DATA_FOR_DAY_MESSAGE = "За данный день у Вас не было %s.";
    public static final String STATISTICS_FOR_DAY_MESSAGE = "Ваша статистика %s за %s📊\n\n";

    public static final String ASK_HISTORY_TYPE_MESSAGE = """
                        Здесь вы можете смотреть историю Ваших доходов и расходов🗂
                        Выберите по какому типу операции Вы хотите посмотреть историю.
                        """;
    public static final String ASK_HISTORY_PERIOD_MESSAGE = "Выберите за какой промежуток времени Вы хотите посмотреть историю\uD83D\uDCC6";
    public static final String NO_HISTORY_DATA_MESSAGE = """
                        У Вас еще нет данных для просмотра истории.
                        Для того чтобы добавить данные вызовите команду /income или /expense
                        """;
    public static final String ASK_HISTORY_YEAR_MESSAGE = "Выберите за какой год Вы хотите посмотреть историю";
    public static final String ASK_HISTORY_MONTH_MESSAGE = "Выберите за какой месяц Вы хотите посмотреть историю";
    public static final String ASK_HISTORY_DAY_MESSAGE = "Выберите за какой день Вы хотите посмотреть историю";
    public static final String HISTORY_FOR_ALL_TIME_MESSAGE = "Ваша история %s за все время🗂\n";
    public static final String HISTORY_FOR_YEAR_MESSAGE = "Ваша история %s за %d год🗂\n";
    public static final String NO_HISTORY_DATA_FOR_MONTH_MESSAGE = "За данный месяц у Вас не было %s.";
    public static final String HISTORY_FOR_MONTH_MESSAGE = "Ваша история %s за %s %d года🗂\n";
    public static final String NO_HISTORY_DATA_FOR_DAY_MESSAGE = "За данный день у Вас не было %s.";
    public static final String HISTORY_FOR_DAY_MESSAGE = "Ваша история %s за %s🗂\n\n";
